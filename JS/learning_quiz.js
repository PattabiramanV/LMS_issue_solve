...
//...............................SessionStorage_Data_Set.................//

// function SessionStorage_Data_Set_Fun(arr,index){

//   // Store index and arr in session storage
// sessionStorage.setItem('index', index);
// sessionStorage.setItem('arr', JSON.stringify(arr));

// // To retrieve the values from session storage later
// let storedIndex = sessionStorage.getItem('index');
// let storedArr = JSON.parse(sessionStorage.getItem('arr'));

// console.log("Stored index:", storedIndex);
// console.log("Stored array:", storedArr);


// sessionStorage.setItem("Quiz_details",Quiz_dtails);
// }
...
//   index=sessionStorage.getItem("index");
//   arr=JSON.parse(sessionStorage.getItem("arr"));
//   // total_mark=sessionStorage.getItem("total_mark");
//   if(arr.length==Quiz_object.length){
//     Quiz_result_div.classList.add("Answer_show_page_classlist");
//     main_quiz_div.classList.add("bootm_content_quiz_classlist");
//     if(find_index==find_language_unlock_module){
...
//   console.log(arr);
//   console.log(Quiz_object[0].Answers);
//   // console.log(Quiz_object[0].Answers==arr);
...
// sessionStorage.setItem('index', index);
// sessionStorage.setItem('arr', JSON.stringify(arr));
// // sessionStorage.setItem('total_mark',total_mark);
